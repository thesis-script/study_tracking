...
export default function Sidebar({ navItems, activeSection, onNavigate, onLogout, user }) {
  return (
    <div className="sidebar"  style={{color: 'white', background: 'linear-gradient(135deg, #1A1D2E 0%, #2D2F4A 50%, #1A1D2E 100%)'}}>
